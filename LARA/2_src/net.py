...
print('at start p_at_10 is', p_at_10, 'p_at_20', p_at_20, 'M_at_10', M_at_10, 'M_at_20', M_at_20, 'G_at_10',
      G_at_10, 'G_at_20', G_at_20)
...
train_data = np.array(pd.read_csv(r'1_data/train_data2.csv'))
...
def train():
    for it in range(800):
        ...
        for D_it in range(D_range):
            ...
            while index < 253236:
                if index + batch_size <= 253236:
                    train_user_batch, train_item_batch, train_attr_batch, train_user_emb_batch = support.get_traindata(
                        index, index + batch_size)
                    counter_user_batch, counter_item_batch, counter_attr_batch, counter_user_emb_batch = support.get_negdata(
                        index, index + batch_size)
                index = index + batch_size
        ...
        if it % 1 == 0:
            ...
            print('movie:::::it', it, 'p_at_10 ', p_at_10, 'p_at_20', p_at_20, 'M_at_10', M_at_10, 'M_at_20', M_at_20,
                  'G_at_10', G_at_10, 'G_at_20', G_at_20)
